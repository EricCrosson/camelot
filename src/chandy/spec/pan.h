...
#define nstates1	20	/* Receiver */
#define minseq1	9
#define maxseq1	27
#define endstate1	19

#define nstates0	10	/* Sender */
#define minseq0	0
#define maxseq0	8
#define endstate0	9
...
#define Air1	(sizeof(P1) - Offsetof(P1, received) - 1*sizeof(uchar))

#define PSender	((P0 *)this)
...
typedef struct State {
	...
	uchar lastSent;
	uchar lastReceived;
	uchar messageAtRecord;
	uchar messageAtMarker;
	uchar ch;
#ifdef TRIX
