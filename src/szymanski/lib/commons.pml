...
#define begin_state_change                   skip; d_step { { count_this--; };
/* Allows an interruption when invoked */
#define interrupt_change                     end_state_change begin_state_change
...
#define end_state_change                  { count_this++; } } possibly_fail();
